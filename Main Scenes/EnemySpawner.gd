...
var preloadedEnemies := [
	...
	preload("res://Variant/Game/Enemy/vPlainEnemy.tscn"), #9
	preload("res://Variant/Game/Enemy/vShootEnemy.tscn"), #10
	preload("res://Variant/Game/Enemy/vShootEnemy2.tscn"), #11
